...
S<keychain [ -hklQqV ]> [ --clear --confhost --confallhosts --debug --gpg2 
--help --ignore-missing --list --noask --nocolor --nogui --noinherit --nolock --quick
--quiet --ssh-allow-forwarded --ssh-rm --ssh-spawn-gpg --systemd --version
S<[ --ssh-agent-socket I<path> ] S<[ --dir I<dirname> ] [ --host I<name> ] 
[ --lockwait I<seconds> ]> S<[ --stop I<which> ] [ --timeout I<minutes> ] 
S<[ --wipe I<ssh|gpg|all> ] [ keys... ]>
