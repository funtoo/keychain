...
necessary. Keychain expects associated public key files to exist in
the same directory as the private key files, with a .pub extension.
As an additional feature, if your private keys have an extension ".ext",
