...
S<--help --ignore-missing --list --noask --nocolor --nogui --noinherit>
S<--nolock --quick --quiet --ssh-allow-forwarded --ssh-rm --ssh-spawn-gpg>
S<--systemd --version ] [ --ssh-agent-socket I<path> ] [ --dir I<dirname> ]>
S<[ --host I<name> ] [ --lockwait I<seconds> ]> [ --stop I<which> ]>
S<[ --timeout I<minutes> ] [ --wipe I<which> ] [ keys... ]>
